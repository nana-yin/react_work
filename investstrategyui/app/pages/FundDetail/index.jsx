...
// 基础信息组件
import Basic from '../../components/FundDetail/Detail/basic'
// 请求基金详情页面的基础信息
import {fundBasic} from '../../mock/fund'
// 业绩表现组件
import MovementsChart from '../../components/FundDetail/Detail/movementsChart'
// 引入风险等标签的颜色,isEmpty判断数据是否为空、业绩表现的日期tab
import { FUND_TYPE,accMul,isEmpty,TABS } from '../../util/fund'
// 历史胜率组件
import Historical from '../../components/FundDetail/Detail/historical'
// 资产分布
import AssetProtfolio from '../../components/FundDetail/Detail/assetProtfolio'
// 行业配置
import IndustyConfig from '../../components/FundDetail/Detail/industyConfig'
// 重仓股票
import HeavyStock from '../../components/FundDetail/Detail/heavyStock'
// 重仓债券
import HeavyBond from '../../components/FundDetail/Detail/heavyBond'
// 引入基金经理组件
import FundManagerCom from '../../components/FundDetail/Detail/fundManager'
// 引入规模分析组件
import ScaleAnalysis from '../../components/FundDetail/Detail/scaleAnalysis'
// 引入情景分析组件
import SceneAnalysis from '../../components/FundDetail/Detail/sceneAnalysis'
// 引入产品报告组件
import ProductReport from '../../components/FundDetail/Detail/productReport'
// 引入系列产品组件
import SeriesProduct from '../../components/FundDetail/Detail/seriesProduct'
// 货币型基金的七日年化收益
import Annual from '../../components/FundDetail/Detail/annual'
// 货币型基金的历史收益
import HistoryEarn from '../../components/FundDetail/Detail/historyEarn'
// 引入当前页面的样式
import './index.less'
const { TabPane } = Tabs
      ...
      return (
        <div className="fundDetail">
          ...
          }
          {
            ...
            <div className="middle-content">
            {
              ...
              <div>
                ...
                <div className="historical">
                  ...
                  <Historical fundId={fundId} fundName={detail.secName} investType={rawInvestType} />
                </div>
              </div>
            }
            {
            ...
            {
              activeTab ==='5' &&
              <SceneAnalysis fundName={detail.secName} benchmarkName="沪深300"/>
            }
            {
              activeTab ==='6' &&
              <ProductReport />
