...
// 引入基金经理的颜色,isEmpty对数据为空进行处理,颜色转换
import {MANAGER_COLOR,isEmpty,accMul,bgColor} from '../../../../util/fund'
// 引入基金经理的数据
import {fundManager} from '../../../../mock/fund'
// 引入echarts
import * as echarts from 'echarts'
// 引入基金经理的列表表头，绘图的模板
import {drawManager} from './chart.config'
// 引入当前页面的样式
import './index.less'
